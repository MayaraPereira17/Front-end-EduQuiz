  ...
  return (
    <>
      ...
      <main className="bg-white">
        <div
          className="w-full h-[763px] md:h-[600px] sm:h-[400px] bg-cover bg-center
      "
        ...
        <div className="grid grid-cols-2 gap-14 ml-16 mt-11 mb-16">
          <div className="mt-16 flex flex-col gap-11">
            <h4 className="text-[#EF6C00] font-bold text-5xl">
              Sobre os Meninos da Caixa
            </h4>
        ...
        <div className="bg-[#E9F4FF] grid grid-cols-2 gap-14 pb-14 shadow-[0_4px_10px_0px_rgba(0,0,0,0.25)]">
          ...
          <div className="mt-16">
            <h4 className="text-[#EF6C00] font-bold text-5xl mb-10">
              Projeto EduQuiz
            </h4>
        ...
        <div
          className="w-full h-[51rem] bg-cover bg-center 
      "
